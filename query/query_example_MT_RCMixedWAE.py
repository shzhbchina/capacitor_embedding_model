...
from dataset_embedding.loss.RMixedWAE_loss import RMixedWAE_loss
...
#error
[loss, recon_loss, mmd_loss] = RMixedWAE_loss(test_output_dataset_x,test_input_dataset,test_output_dataset_z,test_true_table,disc_true_table,loss_conf=loss_conf)
...
#emb dist
type_emb_layer=model.encoder_head.embedding_layers[1]
test_out=type_emb_layer(torch.arange(0,10))
test_dist=torch.cdist(test_out,test_out,p=2)
