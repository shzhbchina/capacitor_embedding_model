...
from dataset_embedding.loss.DiffusionMixedWAE_loss import DiffusionMixedWAE_loss
from train.BaseTrainer import BaseTrainer
from models.DiffusionMixedWassersteinAutoEncoder import DiffusionMixedWAE
import joblib,os
...
MixedWAE_loss_disc=partial(DiffusionMixedWAE_loss,disc_table=disc_true_table)
trainer=BaseTrainer(model,MixedWAE_loss_disc,train_set,val_set,training_config,define_diffusion=True)
