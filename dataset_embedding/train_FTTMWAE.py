...
from models.FTTMixedWassersteinAutoEncoder import FTTMixedWAE
import joblib,os
...
model=FTTMixedWAE(input_dim=dataset.shape[1],hidden_dim=32*1,latent_dim=16,discrete_feature_list=discrete_feature_list,dropout=0.1)
