...
training_config={
    ...
    'scheduler_params':{'CosineAnnealingLR':{'T_max': 2000,'eta_min':1e-7*0.1},
...
model=MaskedMixedWAE(input_dim=dataset.shape[1],hidden_dim=32*4,latent_dim=16*2,disc_dim=4*4,discrete_feature_list=discrete_feature_list,dropout=0.1)
