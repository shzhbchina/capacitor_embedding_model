...
from models.FTT2MixedWassersteinAutoEncoder import FTT2MixedWAE
import joblib,os
...
model=FTT2MixedWAE(input_dim=dataset.shape[1],hidden_dim=32*1,latent_dim=16,discrete_feature_list=discrete_feature_list,dropout=0.1)
