...
from models.MT_MixedWassersteinAutoEncoder import MainMaskedMixedWAE
import joblib,os
...
model=MainMaskedMixedWAE(input_dim=dataset.shape[1],hidden_dim=32*8,latent_dim=16,disc_dim=4*8,discrete_feature_list=discrete_feature_list,dropout=0.01,encoder_path=encoder_path)
