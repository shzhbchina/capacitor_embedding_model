...
from models.MixedWassersteinAutoEncoder import MixedWAE
import joblib,os
...
training_config={
    ...
    'scheduler_params':{'CosineAnnealingLR':{'T_max': 2000,'eta_min':1e-7},
                        'StepLR':{'step_size': 100, 'gamma': 0.9},
...
model=MixedWAE(input_dim=dataset.shape[1],hidden_dim=32*4,latent_dim=8,disc_dim=4,discrete_feature_list=discrete_feature_list)
